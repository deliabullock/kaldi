...
echo -e "------------------finished stage 13, run_ivector_common.sh--------------------\n"
...
echo -e "------------------stage 14 starting inside run_tdnn.sh--------------------\n"
...
echo -e "------------------stage 14 done inside run_tdnn.sh--------------------\n"
echo -e "------------------stage 15 starting inside run_tdnn.sh--------------------\n"
...
echo -e "------------------stage 15 done inside run_tdnn.sh--------------------\n"
echo -e "------------------stage 16 starting inside run_tdnn.sh--------------------\n"
...
echo -e "------------------stage 16 done inside run_tdnn.sh--------------------\n"
...
echo -e "------------------stage 17 done inside run_tdnn.sh--------------------\n"
...
echo -e "------------------stage 18 done inside run_tdnn.sh--------------------\n"
...
echo -e "------------------stage 19 done inside run_tdnn.sh--------------------\n"
...
echo -e "------------------stage 20 done inside run_tdnn.sh--------------------\n"
